...
class UserMessagesControllerTest < ActionController::TestCase
  ...
  test "should create user_message" do
    assert_difference('UserMessage.count') do
      post :create, user_message: { from_user_id: @user_message.from_user_id, message: @user_message.message, subject: @user_message.subject, to_user_id: @user_message.to_user_id }
    end
  ...
  test "should update user_message" do
    put :update, id: @user_message, user_message: { from_user_id: @user_message.from_user_id, message: @user_message.message, subject: @user_message.subject, to_user_id: @user_message.to_user_id }
    assert_redirected_to user_message_path(assigns(:user_message))
  end
